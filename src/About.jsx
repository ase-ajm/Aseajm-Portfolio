function About() {
  return (
    <section id="about" className="section about">
      ...
      <p>
        I previously worked as a Product Area Manager Co-op at Estée Lauder,
        leading training and process improvement initiatives. Outside of work,
        I am building toward running my own business, treating every role along 
        the way as a stepping stone.
      </p>
    </section>
  );
}
